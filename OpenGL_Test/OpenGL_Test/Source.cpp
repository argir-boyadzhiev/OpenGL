...
int main() {
	...
	Shader nShader("shaders/basicShader.vs", "shaders/basicShader.fs");
	Shader asteroidShader("shaders/instancing.vs", "shaders/instancing.fs");
	//instance
	...
	while (!glfwWindowShouldClose(window)) {
		...
		nShader.use();
		nShader.setMat4("view", camera.GetViewMatrix());
