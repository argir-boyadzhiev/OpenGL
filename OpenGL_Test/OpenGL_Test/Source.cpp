...
int main() {
	...
	unsigned int diffuseTexture = loadTexture("C:/Models/tex/wood.png");
	unsigned int normalMap = loadTexture("C:/Models/tex/toy_box_normal.png");
	unsigned int heightMap = loadTexture("C:/Models/tex/toy_box_disp.png");
	...
	Shader mappingShader("shaders/mappingShader.vs", "shaders/mappingShader.fs");
	...
	mappingShader.setMat4("projection", proj);
	...
	while (!glfwWindowShouldClose(window)) {
		...
		lightPos = glm::vec3(sin(glfwGetTime()), cos(glfwGetTime()), 0.0f);
		...
		mappingShader.use();
		mappingShader.setMat4("view", camera.GetViewMatrix());
		mappingShader.setVec3("viewPos", camera.Position);
		mappingShader.setFloat("height_scale", heightScale);
